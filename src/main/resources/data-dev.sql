...
VALUES (1, '2023-06-01 13:00:00', '2026-06-01 14:00:00', 1, ST_SetSRID(ST_MakePoint(-36.5, 174.5), 4326)),
       (2, '2023-06-02 14:00:00', '2023-06-02 16:00', 1, ST_SetSRID(ST_MakePoint(-32.5, 174.5), 4326)),
       (3, '2023-06-03 14:00:00', '2023-06-03 16:00', 1, ST_SetSRID(ST_MakePoint(36.5, 174.5), 4326)),
       (4, '2023-06-04 14:00:00', '2023-06-04 16:00', 1, ST_SetSRID(ST_MakePoint(-36.5, 174.5), 4326)),
       (5, '2023-06-05 11:18:00', '2023-06-05 11:45:00', 2, ST_SetSRID(ST_MakePoint(-35.5, 173.5), 4326));
...
VALUES (1, 1, ST_SetSRID(ST_MakePoint(-36.5, 174.5), 4326), 6, '2023-06-28 11:14:00', 38, 2, 5, 5, 7, 7, 8, 9, 7);
